...
class ComparisonResult:
    ...
    non_cached_metrics: PerformanceMetrics
...
class PerformanceBenchmark:
    ...
    async def measure_operation(
        ...
        **kwargs
        ...
        """Measure performance of an operation with concurrent requests"""
    ...
    async def benchmark_course_retrieval(
        ...
        """Compare cached vs non-cached course retrieval"""
    ...
    async def benchmark_course_listing(
        ...
        """Compare cached vs non-cached course listing"""
    ...
    async def benchmark_mixed_workload(
        ...
        """Benchmark mixed read workload with different cache scenarios"""
        ...
        # Mixed scenario (some cached, some not)
        await self._clear_all_caches()
